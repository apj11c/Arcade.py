...
pacmanImage = pygame.image.load("Images/pacman.png").convert()
	...
	for event in pygame.event.get():
		if event.type == pygame.QUIT:
			if GAMEOVER:
				...
				reply = popUp.exec_()
				crashed = True if reply == QMessageBox.Yes else False
